...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState('home'); // 'home', 'universities', 'portal', 'admin'
  ...
  // Universities list with status ('Approved' or 'Pending')
  ...
  return (
    <div className="min-h-screen bg-[#05070b] text-gray-100 font-sans relative overflow-hidden selection:bg-blue-500 selection:text-white">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all shadow-lg active:scale-95"
                >
                  Logout
                </button>
              </div>
              ...
              <button 
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-xl hover:scale-105 active:scale-95"
              >
                Sign in with Google
              </button>
            )}
      ...
      <main className="p-4 md:p-8 max-w-7xl mx-auto relative z-10">
          ...
          <div className="py-12 md:py-20 text-center max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              <button 
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-8 py-3.5 rounded-2xl font-bold text-sm shadow-xl transition-all hover:scale-105 active:scale-95"
              >
                Browse Universities →
              </button>
              <button 
        ...
        {/* VIEW 2: UNIVERSITIES LIST GRID (Only Approved) */}
                ...
                <div key={uni.id} className="bg-gradient-to-r from-gray-900 to-gray-950 border border-gray-800 p-6 rounded-3xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-xl backdrop-blur-md">
                  ...
                  <div className="flex items-center gap-3 w-full md:w-auto">
                    <button 
                      ...
                      className="flex-1 md:flex-none bg-emerald-600/90 hover:bg-emerald-500 text-white px-5 py-2.5 rounded-xl text-xs font-bold transition shadow-lg shadow-emerald-600/20"
                    >
                      Approve ✓
                    </button>
                    <button 
                      onClick={() => handleAdminAction(uni.id, 'Rejected')}
                      className="flex-1 md:flex-none bg-rose-600/90 hover:bg-rose-500 text-white px-5 py-2.5 rounded-xl text-xs font-bold transition shadow-lg shadow-rose-600/20"
                    >
                      Reject ✕
                    </button>
                  </div>
                      ...
                      <div key={cand.id} className="bg-gradient-to-b from-gray-900/90 to-gray-950/90 border border-gray-800/80 p-6 rounded-3xl space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <button 
                            ...
                            className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-6 py-2.5 rounded-xl text-sm font-semibold shadow-lg active:scale-95"
                          >
                            Cast Vote
                          </button>
                        </div>
